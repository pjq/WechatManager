...
import me.pjq.wechat.Authentication;
    ...
    protected void checkSignature(SignatureInfo sign, int timestampLimit) throws WeixinException {
        ...
        if (sign.signature != null && sign.timestamp != null && sign.nonce != null) {
            ...
            try {
                ...
                long interval = expectTimestamp - timestamp;
                System.out.println("interval = " + interval);
                if (Math.abs(expectTimestamp - timestamp) <= timestampLimit * 1000) {
//                	if (Authentication.isSignatureMatch(sign)) {
//						return;
//					}
